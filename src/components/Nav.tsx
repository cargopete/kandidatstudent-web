...
export default function Nav({ institutions, fields, specialties }: Props) {
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-slate-200 px-6 py-0">
        <div className="max-w-4xl mx-auto flex items-center gap-4 h-14">
          <Link
            href="/"
            className="text-sm font-bold text-slate-900 tracking-tight shrink-0 hover:text-indigo-600 transition-colors"
          >
            kandidatstudent.com
          </Link>
